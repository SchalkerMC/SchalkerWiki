...
<table>
    ...
    <tbody>
        <tr>
            <td><img src="voicechat/voicechat1_icon.png" alt="" data-size="original"></td>
            <td>Вы говорите</td>
        </tr>
        <tr>
            <td><img src="voicechat/voicechat2_icon.png" alt="" data-size="original"></td>
            <td>Вы шепчете</td>
        </tr>
        <tr>
            <td><img src="voicechat/voicechat3_icon.png" alt="" data-size="original"></td>
            <td>Игрок говорит</td>
        </tr>
        <tr>
            <td><img src="voicechat/voicechat4_icon.png" alt="" data-size="original"></td>
            <td>Игрок шепчет</td>
        </tr>
        <tr>
            <td><img src="voicechat/voicechat5_icon.png" alt="" data-size="original"></td>
            <td>Микрофон отключен</td>
        </tr>
        <tr>
            <td><img src="voicechat/voicechat6_icon.png" alt="" data-size="original"></td>
            <td>Голосовой чат отключен</td>
        </tr>
        <tr>
            <td><img src="voicechat/voicechat7_icon.png" alt="" data-size="original"></td>
